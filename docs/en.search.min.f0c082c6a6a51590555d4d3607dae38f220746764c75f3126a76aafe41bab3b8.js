...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/mhb_test/flexsearch.min.js');loadScript('/mhb_test/en.search-data.min.617549220a144f2558219aa26bd1be88d4e0c23264834477d92f524abb7eac0d.js',function(){input.required=false;search();});}
