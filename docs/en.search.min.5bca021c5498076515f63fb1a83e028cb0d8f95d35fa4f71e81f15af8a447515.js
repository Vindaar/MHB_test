...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.55291e00cb9e894079910013e8052abefbca97b61d82ca61b20db052801799f5.js',function(){input.required=false;search();});}
