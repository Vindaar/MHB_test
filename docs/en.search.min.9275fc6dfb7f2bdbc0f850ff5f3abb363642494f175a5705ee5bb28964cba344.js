...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/mhb_test/flexsearch.min.js');loadScript('/mhb_test/en.search-data.min.8166b44ba81b56482f5b37f1039c3560f6588018cbed336987079fa3e4b442a7.js',function(){input.required=false;search();});}
